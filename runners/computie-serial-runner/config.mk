...
CFLAGS = -I$(INCLUDE) $(CFLAGS_ARCH) -nostartfiles -nostdlib -fno-zero-initialized-in-bss -g -Os -mpcrel
LDFLAGS = -Wl,--build-id=none

MAKE_LOAD_FILE = /media/work/computie/software/tools/make-load-file
